...
// 188 overloads were generated with the following return types:
...
public func => <A: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A]?]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(catchNull(decodeArray(A.decode)))))
}
...
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A: B]?]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(catchNull(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))))
}
...
///
public func => <A: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A?]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(catchNull(A.decode))))
}
...
///
public func => <A: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A?]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeArray(catchNull(A.decode)))))
}
...
///
public func => <A: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[[A]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeArray(decodeArray(A.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[[A: B]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))))
}
...
///
public func => <A: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeArray(A.decode))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A: B?]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A: [B]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode)))))
}
...
public func => <A: Decodable, B: Decodable, C: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A: [B: C]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [[A: B]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode))))
}
...
///
public func => <A: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeArray(A.decode)))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B]?]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeArray(B.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable, C: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B: C]?]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: B?]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B?]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(catchNull(B.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [[B]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeArray(B.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable, C: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [[B: C]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode))))
}
...
///
public func => <A: Decodable, B: Decodable, C: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B: C?]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: catchNull(C.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable, C: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B: [C]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeArray(C.decode)))))
}
...
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B: [C: D]]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: D.decode)))))
}
...
///
public func => <A: Decodable, B: Decodable, C: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: [B: C]]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode))))
}
...
///
public func => <A: Decodable, B: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> [A: B]? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))
}
...
///
public func => <A: Decodable>(json: AnyObject, keyPath: OptionalKeyPath) throws -> A? {
    return try parse(json, keyPath: keyPath.markingFirst(required: true), decode: catchNull(A.decode))
}
