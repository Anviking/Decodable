...
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[A]?]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(catchNull(decodeArray(A.decode)))))
}
...
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: B]?]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(catchNull(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [A?]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(catchNull(A.decode))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[A?]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeArray(catchNull(A.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[[A]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeArray(decodeArray(A.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[[A: B]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[A]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeArray(A.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: B?]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: [B]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode)))))
}
...
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[A: [B: C]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: B]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [A]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeArray(A.decode)))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [B]?]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: C]?]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: B?]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [B?]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(catchNull(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [[B]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [[B: C]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [B]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: C?]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: catchNull(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeArray(C.decode)))))
}
...
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C: D]]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: D.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: C]]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: B]? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> A? {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(catchNull(A.decode))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[A?]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeArray(catchNull(A.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[[A]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeArray(decodeArray(A.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[[A: B]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[A]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeArray(A.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: B?]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: [B]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[A: [B: C]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: B]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(decodeDictionary(A.decode, elementDecodeClosure: B.decode))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [A?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(catchNull(A.decode)))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[[A]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(catchNull(decodeArray(A.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[[A: B]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(catchNull(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[A?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(catchNull(A.decode))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[[A?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeArray(catchNull(A.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[[[A]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeArray(decodeArray(A.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[[[A: B]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[[A]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeArray(A.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[[A: B?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[[A: [B]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[[A: [B: C]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[[A: B]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode))))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [[A]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeArray(A.decode)))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: [B]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[A: [B: C]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: B?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: [B?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(catchNull(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: [[B]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[A: [[B: C]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: [B]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[A: [B: C?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: catchNull(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[A: [B: [C]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeArray(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [[A: [B: [C: D]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: D.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [[A: [B: C]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [[A: B]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(decodeDictionary(A.decode, elementDecodeClosure: B.decode)))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> [A] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeArray(A.decode))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [B?]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeArray(catchNull(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [[B]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeArray(decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [[B: C]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeArray(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [B]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeArray(B.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: C?]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeDictionary(B.decode, elementDecodeClosure: catchNull(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeDictionary(B.decode, elementDecodeClosure: decodeArray(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C: D]]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: D.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: C]?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(decodeDictionary(B.decode, elementDecodeClosure: C.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: B?] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: catchNull(B.decode)))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [[B]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(catchNull(decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [[B: C]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(catchNull(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [B?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(catchNull(B.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [[B?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeArray(catchNull(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [[[B]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeArray(decodeArray(B.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [[[B: C]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeArray(decodeDictionary(B.decode, elementDecodeClosure: C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [[B]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeArray(B.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [[B: C?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeDictionary(B.decode, elementDecodeClosure: catchNull(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [[B: [C]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeDictionary(B.decode, elementDecodeClosure: decodeArray(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [[B: [C: D]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: D.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [[B: C]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(decodeDictionary(B.decode, elementDecodeClosure: C.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: [B]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeArray(B.decode)))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: catchNull(decodeArray(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C: D]?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: catchNull(decodeDictionary(C.decode, elementDecodeClosure: D.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: C?]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: catchNull(C.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeArray(catchNull(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [[C]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeArray(decodeArray(C.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [[C: D]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeArray(decodeDictionary(C.decode, elementDecodeClosure: D.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeArray(C.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C: D?]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: catchNull(D.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C: [D]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: decodeArray(D.decode)))))
}
...
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable, E: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C: [D: E]]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: decodeDictionary(D.decode, elementDecodeClosure: E.decode)))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable, D: Decodable>(object: AnyObject, key: String)throws-> [A: [B: [C: D]]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: decodeDictionary(C.decode, elementDecodeClosure: D.decode))))
}
...
*/
public func => <A: Decodable, B: Decodable, C: Decodable>(object: AnyObject, key: String)throws-> [A: [B: C]] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: decodeDictionary(B.decode, elementDecodeClosure: C.decode)))
}
...
*/
public func => <A: Decodable, B: Decodable>(object: AnyObject, key: String)throws-> [A: B] {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(decodeDictionary(A.decode, elementDecodeClosure: B.decode))
}
...
*/
public func => <A: Decodable>(object: AnyObject, key: String)throws-> A {
    return try IntermediateResult(object: object, rootObject: object, path: []).parse(key).decode(A.decode)
}
